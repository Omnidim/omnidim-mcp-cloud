...
def _build_outbound_campaign(args: dict[str, Any]) -> str:
    ...
    return (
        ...
        "   Add `call_conditions` to dial only matching contacts, and `rotation` when dialing from several\n"
        "   numbers (see the bulk-campaigns resource for the shape). Keep the returned `id`.\n"
